...
public class lab {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Digiteme el nombre de su archivo");
    ...
    public static void llenar(Scanner hjet, String nombredelarchivo) {
        ...
        try (FileWriter filew = new FileWriter(nombredelarchivo +".txt", true)) {
            ...
            ordenar(ordenador, usuariosc);
            for(int i=ordenador.length-usuariosc;i<ordenador.length;i++){
                System.out.println("Digite la informacion de la cedula: "+ordenador[i]);
                ...
                if (!cedula.isEmpty() && !nombre.isEmpty() && !dir.isEmpty() && !celular.isEmpty() && !email.isEmpty()){
                    printw.println(ordenador[i] +"\t"+ nombre +"\t"+ dir +"\t"+ celular +"\t"+ email);
                }
            }
    ...
    //Ordenar la cedula por burbuja
    public static void ordenar(int ordenador[],int uwu){
